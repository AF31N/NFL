          ...
          {data.map((item, index) => (
            <div key={index} className=' justify-center gap-6 group'>
              <div className='w-full flex justify-between items-center group-hover:text-accent-hover transition-all duration-500 ' >
                ...
                <Link className='w-[50px] h-[50px] rounded-full bg-white flex justify-center items-center group-hover:bg-accent-hover  transition-all hover:-rotate-45 duration-700'  href="/">
